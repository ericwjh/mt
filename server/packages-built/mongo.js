(function() {
  ...
  var require = meteorInstall({
    "node_modules": {
      "meteor": {
        "mongo": {
          "mongo_driver.js": ["babel-runtime/helpers/typeof", function(require, exports, module) {
            ...
            MongoConnection.prototype._maybeBeginWrite = function() { 
              ...
              if (fence) return fence.beginWrite();
              else return {
                ...
                if (options.upsert && !knownId && options.insertedId) { 
                  ...
                  simulateUpsertWithInsertedId(collection, mongoSelector, mongoMod, isModify, options, 
                    ...
                    function(err, result) { 
                      ...
                      if (result && !options._returnObject) callback(err, result.numberAffected);
            ...
            var simulateUpsertWithInsertedId = function simulateUpsertWithInsertedId(collection, selector, mod, isModify, options, callback) {
              ...
              var doConditionalInsert = function doConditionalInsert() { 
                var replacementWithId = _.extend(replaceTypes({
                  _id: insertedId
                }, replaceMeteorAtomWithMongo), newDoc); 
            ...
            MongoConnection.prototype._observeChanges = function(cursorDescription, ordered, callbacks) { 
              ...
              var observeKey = JSON.stringify(_.extend({
                ordered: ordered
              }, cursorDescription)); 
          ...
          "oplog_tailing.js": function(require) {
            ...
            idForOp = function idForOp(op) { 
              if (op.op === 'd') return op.o._id;
              else if (op.op === 'i') return op.o._id;
              else if (op.op === 'u') return op.o2._id;
              else if (op.op === 'c') throw Error("Operator 'c' doesn't supply an object with id: " + EJSON.stringify(op));
              else throw Error("Unknown op: " + EJSON.stringify(op));
            }; 
            ...
            _.extend(OplogHandle.prototype, { 
              ...
              waitUntilCaughtUp: function waitUntilCaughtUp() { 
                ...
                while (!self._stopped) { 
                  ...
                  try { 
                    var lastEntry = self._oplogLastEntryConnection.findOne(OPLOG_COLLECTION, self._baseOplogSelector, {
                      fields: {
                        ts: 1
                      },
                      sort: {
          ...
          "observe_multiplex.js": function(require) {
            ...
            _.extend(ObserveMultiplexer.prototype, { 
              ...
              callbackNames: function callbackNames() { 
                var self = this; 
                if (self._ordered) return ["addedBefore", "changed", "movedBefore", "removed"];
                ...
                self._stopHandles.push(self._mongoHandle._oplogHandle.onOplogEntry(trigger, function(notification) { 
                  Meteor._noYieldsAllowed(finishIfNeedToPollQuery(function() { 
                    ...
                    if (notification.dropCollection || notification.dropDatabase) { 
                      ...
                      if (self._phase === PHASE.QUERYING) self._handleOplogEntryQuerying(op);
                      else self._handleOplogEntrySteadyOrFetching(op);
                    } 
                  })); 
                })); 
              }); 
                ...
                while (true) { 
                  ...
                  try { 
                    cursor.forEach(function(doc, i) { 
                      // yields                                                                                                   
                      if (!self._limit || i < self._limit) newResults.set(doc._id, doc);
                      else newBuffer.set(doc._id, doc); 
                    }); 
                    break; 
                  } catch (e) { 
          ...
          "collection.js": function(require, exports, module) {
            ...
            Mongo.Collection = function(name, options) { 
              ...
              else if (options.connection) self._connection = options.connection;
              else if (Meteor.isClient) self._connection = Meteor.connection;
              else self._connection = Meteor.server;
