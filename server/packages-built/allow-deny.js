...
CollectionPrototype._defineMutationMethods = function () {                                                        
  ...
  if (self._connection) {                                                                                         
    (function () {                                                                                                
      ...
      if (Meteor.isClient || self._connection === Meteor.server) self._connection.methods(m);                     
    })();                                                                                                         
  }                                                                                                               
};                                                                                                                
...
CollectionPrototype._validatedInsert = function (userId, doc, generatedId) {                                      
  ...
  if (_.any(self._validators.insert.deny, function (validator) {                                                  
    ...
    throw new Meteor.Error(403, "Access denied2");                                                                 
  }                                                                                                               
  // Any allow returns true means proceed. Throw error if they all fail.                                          
  if (_.all(self._validators.insert.allow, function (validator) {                                                 
    return !validator(userId, docToValidate(validator, doc, generatedId));                                        
  })) {                                                                                                           
    throw new Meteor.Error(403, "Access denied3");                                                                 
  }                                                                                                               
...
CollectionPrototype._validatedUpdate = function (userId, selector, mutator, options) {                            
  ...
  if (_.any(self._validators.update.deny, function (validator) {                                                  
    ...
    throw new Meteor.Error(403, "Access denied4");                                                                 
  }                                                                                                               
  // Any allow returns true means proceed. Throw error if they all fail.                                          
  if (_.all(self._validators.update.allow, function (validator) {                                                 
    ...
    throw new Meteor.Error(403, "Access denied5");                                                                 
  }                                                                                                               
...
CollectionPrototype._validatedRemove = function (userId, selector) {                                              
  ...
  if (_.any(self._validators.remove.deny, function (validator) {                                                  
    ...
    throw new Meteor.Error(403, "Access denied6");                                                                 
  }                                                                                                               
  // Any allow returns true means proceed. Throw error if they all fail.                                          
  if (_.all(self._validators.remove.allow, function (validator) {                                                 
    return !validator(userId, transformDoc(validator, doc));                                                      
  })) {                                                                                                           
    throw new Meteor.Error(403, "Access denied7");                                                                 
  }                                                                                                               
...
CollectionPrototype._callMutatorMethod = function _callMutatorMethod(name, args, callback) {                      
  ...
  return this._connection.apply(mutatorMethodName, args, { returnStubValue: true }, callback);                    
};                                                                                                                
