...
Blaze.View.prototype.lookup = function (name, _options) {
  ...
  . looking up the parent data context with the special "../" syntax
  if (/^\./.test(name)) {
  ...
  . look up a binding by traversing the lexical view hierarchy inside the
  // current template
